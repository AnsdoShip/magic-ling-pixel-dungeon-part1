                    ...
                    if (PathFinder.distance[cell] < Integer.MAX_VALUE) {
                        ...
                        if (h != null) {
                            for (Item i : h.items.toArray(new Item[0])) {
                                if (i instanceof NewTengu.BombAbility.BombItem) {
                                    h.remove(i);
                                }
                            }
                        }
        ...
        public static class BombItem extends Item {
            ...
            protected void onThrow(int cell) {
                ...
                if (throwingChar != null){
                    Buff.append(throwingChar, NewTengu.BombAbility.class).bombPos = cell;
                    throwingChar = null;
                } else {
                    Buff.append(curUser, NewTengu.BombAbility.class).bombPos = cell;
                }
            }
