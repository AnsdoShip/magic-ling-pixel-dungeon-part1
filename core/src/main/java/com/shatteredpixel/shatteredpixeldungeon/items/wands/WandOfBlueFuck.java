...
public class WandOfBlueFuck extends DamageWand {
    ...
    public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
        ...
        {
            inputs =  new Class[]{PotionOfLiquidFlameX.class, WandOfFireblast.class, ScrollOfFlameCursed.class};
    ...
    public int min(int lvl){
        return (5+lvl+Dungeon.depth/5) * chargesPerCast();
    }

    //1x/2x/3x damage
    public int max(int lvl){
        return (12+2*lvl+Dungeon.depth/5) * chargesPerCast();
    }
