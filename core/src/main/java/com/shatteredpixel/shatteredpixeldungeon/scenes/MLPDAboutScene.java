...
public class MLPDAboutScene extends PixelScene {
    ...
    private static String LNK_MLPD_SOURCE() { return "https://github.com/AnsdoShip/MagicLingPixelDungeon/";}
    ...
    public void create() {
        ...
        new Flare( 7, 64 ).color( Window.MLPD_COLOR, true ).show( ling, 0 ).angularSpeed = +20;
