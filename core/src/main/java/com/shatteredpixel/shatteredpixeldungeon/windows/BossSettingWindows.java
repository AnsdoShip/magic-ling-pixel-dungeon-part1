...
public class BossSettingWindows extends Window {
    ...
    private ArrayList<WndChallenges.CanScrollInfo> infos;
    ...
    public BossSettingWindows(){
        ...
        RenderedTextBlock rtb = PixelScene.renderTextBlock(M.L(this, "title"), TTL_HEIGHT - GAP);
        ...
        cbs = new ArrayList<>();
        for(int i = 0; i<5; ++i){
            CheckBox cb = new CheckBox(M.L(this, "boss_"+String.valueOf(i+1)));
